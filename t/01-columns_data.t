...
my $cd = $rs[0];
my $rh_result = {'artistid' => $cd->artistid(),'cdid' => $cd->cdid(),'title' => $cd->title, 'date' => undef, 'last_listen' => undef, 'real_end_date' => '1987-12-18 16:12:47', 'real_start_date' => '1987-12-18 16:12:47'};
...
my $rh_result_date_with_title = {'artistid' => $cd->artistid(),'cdid' => $cd->cdid(),'title' => $cd->title, 'date' => $format_date, 'last_listen' => $format_last_listen, 'real_end_date' => '1987-12-18 16:12:47', 'real_start_date' => '1987-12-18 16:12:47'};
...
my $rh_result_date = {'artistid' => $cd->artistid(),'cdid' => $cd->cdid(), 'date' => $format_date, 'last_listen' => $format_last_listen, 'real_end_date' => '1987-12-18 16:12:47', 'real_start_date' => '1987-12-18 16:12:47'};
